...
import IPayCardIssuance from '@app/components/templates/ipay-card-issuace-summary/ipay-card-issuace-summary.component';
  ...
  return (
    <IPaySafeAreaView>
      <MainStack.Navigator screenOptions={{ headerShown: false }}>
        <MainStack.Screen name={screenNames.HOME_BASE} options={{ headerShown: false }} component={IPayCardIssuance} />
