...
import { IPayCaption1Text, IPayPressable, IPaySubHeadlineText, IPayView } from '@app/components/atoms';
...
import { EmptyBox } from '@app/assets/svgs';
  ...
  return (
    <IPaySafeAreaView style={styles.safeArea}>
      ...
      <IPayView style={styles.bannerContainer}>
        {hasPendingRequest ? (
          <>
            <SectionHeader leftText={localization.NOTIFICATION_CENTER.REQUESTS} />
          ...
          <>
            <SectionHeader
              ...
              subText={
                hasPendingRequest ? `(${pendingNotificationsCount} ${localization.NOTIFICATION_CENTER.PENDING})` : ''
              }
