...
The Terms and Conditions therefore, represent the document that helps in dealing with problems or preventing them in the first place. Because of that, the Terms and Conditions are fundamental in many cases in order to mount an adequate and proper defense represent the document that helps in  `,
  ...
  CITIES: [
    { id: 1, cityName: 'Riyadh' },
    { id: 2, cityName: 'Jeddah' },
    { id: 3, cityName: 'Makkah' },
    { id: 4, cityName: 'Madinah' },
    { id: 5, cityName: 'Dammam' },
    { id: 6, cityName: 'Al-Khobar' },
    { id: 7, cityName: 'Taif' },
    { id: 8, cityName: 'Tabuk' },
    { id: 9, cityName: 'Buraidah' },
    { id: 10, cityName: 'Najran' },
    { id: 11, cityName: 'Jizan' },
    { id: 12, cityName: 'Hail' },
    { id: 13, cityName: 'Abha' },
    { id: 14, cityName: 'Yanbu' },
    { id: 15, cityName: 'Khobar' },
    { id: 16, cityName: 'Qatif' },
    { id: 17, cityName: 'Ras Tanura' },
    { id: 18, cityName: 'Khobar' },
    { id: 19, cityName: 'Dhahran' },
    { id: 20, cityName: 'Qassim' },
    { id: 21, cityName: 'Jubail' },
    { id: 22, cityName: 'Bisha' },
    { id: 23, cityName: 'Al Kharj' },
    { id: 24, cityName: 'Arar' },
    { id: 25, cityName: 'Al Bahah' },
    { id: 26, cityName: 'Sakaka' },
    { id: 27, cityName: 'Jeddah' },
    { id: 28, cityName: 'Riyadh' },
    { id: 29, cityName: 'Makkah' },
    { id: 30, cityName: 'Madinah' },
  ],
