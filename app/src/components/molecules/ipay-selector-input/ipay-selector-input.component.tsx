...
import { IPayInput, IPayCaption1Text, IPayImage, IPayPressable, IPayView } from '@components/atoms/index';
    ...
    <IPayView testID={`${testID}-selector`} style={styles.outerWrapper}>
      <IPayView style={[
        ...
        <IPayView style={styles.iconAndInputStyles}>
          ...
          >
            {variant == inputVariants.PHONE_NUMBER ? <IPayImage
              image={flagImage} style={styles.flag} /> :
          ...
          <IPayView style={styles.outerView}>
            <IPayCaption1Text text={variant == inputVariants.PHONE_NUMBER ? t('phoneNumber') : t('currency')} style={[styles.label, !editable && styles.disableLabel, headingStyles,]} regular />
            <IPayView style={styles.rowStyles}>
              {variant == inputVariants.PHONE_NUMBER && <IPayCaption1Text text={countryCode} style={[styles.numberValue]} regular />}
              <IPayInput
                isFocused={isFocused}
