...
interface IPayGradientListProps {
  ...
  titleStyle?: TextStyle; // Optional style object for customizing the title text style
  subTitleStyle?: TextStyle; // Optional style object for customizing the subtitle text style
