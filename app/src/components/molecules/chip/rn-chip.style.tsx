import { SCALE_10, SCALE_12, SCALE_16, SCALE_2, SCALE_8 } from '@app/styles/spacing';
...
export const getColorsStyle = (variant: variants, headingStyles?: TextStyle): { textStyle: TextStyle, backgroundStyle: ViewStyle } => {
  return {
    textStyle: {
