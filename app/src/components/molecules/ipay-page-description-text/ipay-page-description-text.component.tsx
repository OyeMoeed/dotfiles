...
const IPayPageDescriptionText: React.FC<IPayPageDescriptionTextProps> = ({ testID, heading, text, style }) => {
  ...
  return (
    <IPayView testID={`${testID}-page-description`} style={[styles.container, style]}>
      ...
      {text && <IPayCaption1Text regular text={text} style={styles.subHeading} />}
    </IPayView>
  );
};
