...
import { SCALE_14, SCALE_16 } from '@styles/spacing';
import React from 'react';
import { Provider } from 'react-redux';

const RNTextMeta: Meta<typeof RNText> = {
  title: 'components/text/rn-subheadline-text/RNText',
  component: RNText,
  args: {
    text: 'Hello world',
    style: {
...
export const SubHeadlineRegular: StoryObj<typeof RNText> = {
  args: {
    text: 'Hello world',
    style: {
      color: colors.black,
...
export const SubHeadlineBold: StoryObj<typeof RNText> = {
  args: {
    text: 'Hello world',
    style: {
      color: colors.black,
