...
import { TestPrepareIdRenewalProp } from './id-renewal.interface';
import getWalletInfoMock from './id-renewal.mock';
import { prepareRenewId } from './id-renewal.service';
...
describe('getWalletInfo', () => {
  const mockPayload: TestPrepareIdRenewalProp = { walletNumber: '123456' };
  ...
  it('should return mock data and dispatch setWalletInfo when MOCK_API_RESPONSE is true', async () => {
    ...
    const result = await prepareRenewId(mockPayload);
