import { TopupCardsResponseDetails } from './topup-cards.interface';

const topupCardsMock: TopupCardsResponseDetails = {
  response: {
    cardList: [
      {
        expirationYear: '2030',
...
const topupCardStatusMock = {
  ...
  response: {
    transactionId: 'TST2425900199121',
    ...
    pmtResultCd: 'P',
    pmtStatusCode: 600,
    transactionTime: '2024-09-15T21:02:44Z',
    successfulResponse: true,
  },
};

export { topupCardsMock, topupCardStatusMock };
