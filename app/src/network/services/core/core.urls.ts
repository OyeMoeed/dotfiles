...
const CORE_URLS = {
  ...
  GENERATE_INVOICE: (walletNumber?: string, trxId?: string, trxDate?: string) => `core-management/v1/transaction/${walletNumber}/vat-invoice?transaction-id=${trxId}&transaction-date=${trxDate}`,
